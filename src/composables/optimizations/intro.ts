...
export function useSetScroll(enable: boolean | string, saveConfig = true) {
  ...
  CSSOM.insertRule(`${ selector } { max-height: 120px; overflow: hidden auto; display: block; -webkit-box-orient: unset; -webkit-line-clamp: unset; position: relative;pointer-events: auto;}`)
